...
### Steps
(1) cd public/genesys/GeneSys-RTL/ -> This is a git submodule that links the Genesys RTL repo (https://github.com/actlab-genesys/GeneSys.git)
(2) Follow the steps in the repo to either run tests on RTL simulation or FPGA
