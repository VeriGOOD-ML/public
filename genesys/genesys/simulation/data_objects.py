...
class HardwareObject(object):
    ...
    def __init__(self, Hardware_config, Mode):
        # this object takes the GeneSys Hardware parameters as input
        ...
        self.Size_OBUF = 2 * Hardware_config['OBUF_CAPACITY_BITS']/(8 * 1024)  # the current hardware config file provides param for OBUF1, hence multiply by 2
        ...
        self.SIMD_bw = 32   # current GeneSys SIMD is 32 bit
        ...
        #later this might need to be attached to each memory, basically IMM and InsMem is single buffered always, VMEM is single buffer now, maybe made double buffer later
...
class SIMDResult_Inflayer(object):
    ...
    def __init__(self):
        ...
        # when systolic and SIMD operations are fused, it will need seperate overlap model of time between SA and SIMD
        self.cycles = {}
        self.cycles['compute'] = 0
        self.cycles['DRAM_stall'] = 0
        self.cycles['total'] = 0
