...
if 0 {
setAddStripeMode -stacked_via_bottom_layer C5 -stacked_via_top_layer G1
addStripe -nets { VSS VDD } \
          -layer G1 \
          ...
          -width 2.160 \
          -spacing 1.440 \
          -set_to_set_distance 7.20 \
          -extend_to all_domains
 
setAddStripeMode -stacked_via_bottom_layer G1 -stacked_via_top_layer G2
addStripe -nets { VSS VDD } \
          -layer G2 \
          -direction vertical \
          -ybottom_offset 1.08 \
