...
set lef "
    ...
    ${sramdir}/lef/DPRFW8B8.lef \
    ${sramdir}/lef/DPRFW176B8.lef \
    ${sramdir}/lef/DPRFW48B24.lef \
...
set libworst "
    ...
    ${sramdir}/lib/DPRFW8B8_sspg_sigcmax_0p72v_0p72v_125c.lib \
    ${sramdir}/lib/DPRFW176B8_sspg_sigcmax_0p72v_0p72v_125c.lib \
    ${sramdir}/lib/DPRFW48B24_sspg_sigcmax_0p72v_0p72v_125c.lib \
...
set libpower "
    ...
    ${sramdir}/lib/DPRFW8B8_ffpg_sigcmin_0p88v_0p88v_125c.lib \
    ${sramdir}/lib/DPRFW176B8_ffpg_sigcmin_0p88v_0p88v_125c.lib \
    ${sramdir}/lib/DPRFW48B24_ffpg_sigcmin_0p88v_0p88v_125c.lib \
...
set libbest "
    ...
    ${sramdir}/lib/DPRFW8B8_ffpg_sigcmin_0p88v_0p88v_m40c.lib \
    ${sramdir}/lib/DPRFW176B8_ffpg_sigcmin_0p88v_0p88v_m40c.lib \
    ${sramdir}/lib/DPRFW48B24_ffpg_sigcmin_0p88v_0p88v_m40c.lib \
