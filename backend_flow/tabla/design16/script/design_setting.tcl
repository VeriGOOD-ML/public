...
set lef "
    ...
    ${sramdir}/lef/DPRFW16B8.lef \
    ${sramdir}/lef/DPRFW352B8.lef \
    ${sramdir}/lef/DPRFW128B24.lef \
    ${sramdir}/lef/DPRFW96B24.lef \
...
set libworst "
    ...
    ${sramdir}/lib/DPRFW16B8_sspg_sigcmax_0p72v_0p72v_125c.lib \
    ${sramdir}/lib/DPRFW352B8_sspg_sigcmax_0p72v_0p72v_125c.lib \
    ${sramdir}/lib/DPRFW128B24_sspg_sigcmax_0p72v_0p72v_125c.lib \
    ${sramdir}/lib/DPRFW96B24_sspg_sigcmax_0p72v_0p72v_125c.lib \
...
set libpower "
    ...
    ${sramdir}/lib/DPRFW16B8_ffpg_sigcmin_0p88v_0p88v_125c.lib \
    ${sramdir}/lib/DPRFW352B8_ffpg_sigcmin_0p88v_0p88v_125c.lib \
    ${sramdir}/lib/DPRFW128B24_ffpg_sigcmin_0p88v_0p88v_125c.lib \
    ${sramdir}/lib/DPRFW96B24_ffpg_sigcmin_0p88v_0p88v_125c.lib \
...
set libbest "
    ...
    ${sramdir}/lib/DPRFW16B8_ffpg_sigcmin_0p88v_0p88v_m40c.lib \
    ${sramdir}/lib/DPRFW352B8_ffpg_sigcmin_0p88v_0p88v_m40c.lib \
    ${sramdir}/lib/DPRFW128B24_ffpg_sigcmin_0p88v_0p88v_m40c.lib \
    ${sramdir}/lib/DPRFW96B24_ffpg_sigcmin_0p88v_0p88v_m40c.lib \
