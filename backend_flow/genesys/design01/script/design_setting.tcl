...
set lef "
    ...
    ${sramdir}/lef/DPRFW128B4.lef \
    ${sramdir}/lef/DPRFW2048B4.lef \
...
set libworst "
    ...
    ${sramdir}/lib/DPRFW128B4_tt_nominal_0p80v_0p80v_25c.lib \
    ${sramdir}/lib/DPRFW2048B4_tt_nominal_0p80v_0p80v_25c.lib \
